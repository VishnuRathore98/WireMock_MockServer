...
//        stubFor(any((anyUrl())).willReturn(ok("You have been served!!")));
...
//    It will verify how many times the request is made.
    public static void verifyGetStub(){
        verify(0,getRequestedFor(urlPathEqualTo("/fraudCheck/1111-1111-1111-1112")));
